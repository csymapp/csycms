...
====================
  ...
  * **[New]** CSYCMS can be served from non-root path (URI Prefix)
    - contributed by **@gugu**
...
====================
  ...
  * **[Improvement]** Table of Contents (Dynamic)
    - contributed by **@Sparticuz**
  * **[Misc]** Merged `CSYCMS-Core` module into repository
  * **[Misc]** Dependency upgrades
...
====================
  ...
  * **[Misc]** Upgrading CSYCMS-core from v0.4.0 to v0.5.0
...
===================
  ...
  * **[Upgraded]** Module CSYCMS-core from v0.2.0 to v0.4.0
...
===================
  ...
  * **[New]** Added ability to run CSYCMS as a PM2 service
    - contributed by **@matthiassb**
...
===================
  ...
  * **[New]** Preparing for CSYCMS to be NPM-installable (see example/ for new usage)
...
==========================
  ...
  * **[New]** Changed app structure (now using CSYCMS-core)
...
==========================
  ...
  * **[Changed]** Moved route and error handlers to CSYCMS.js
...
==========================
  ...
  * **[Fixed]** Added better handling of file reading errors in CSYCMS.js
